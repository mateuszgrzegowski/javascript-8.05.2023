...
setInterval(function() {console.log(box1.getClientRects().top)},1000);
...
setInterval(function() {box1.getBoundingClientRect().top <=0 ? changeClass(): null}, 1000/60);
...
let interval2 = setInterval(function() {box2.getBoundingClientRect().top <= 0 ? changeClass() : null, 1000/60});

let interval3;

function startAnimation(){
    internal3 = setInterval(animation, 1000/(60 * 2));
